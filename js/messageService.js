angular.module('chatroom').service('messageService', function($http){
  ...
  //On the lines below create a getMessages method. This method will retrieve data
  // from the backend.
  ...
  //to give it,
  //in your $http call (along with url and method) have a data property which has a
  // value that is equal to another object which a key of message and a value of
